...
COLLECTION_NAME = collection_name = os.getenv("COLLECTION_NAME")
password = os.getenv("DB_PASSWORD")
username = "antaladhaval02ad_db_user"
safe_username = urllib.parse.quote_plus(username)
safe_password = urllib.parse.quote_plus(password)
MONGODB_URL_KEY = f"mongodb+srv://{safe_username}:{safe_password}@cluster0.95ablet.mongodb.net/?appName=Cluster0"
...
MODEL_BUCKET_NAME = "frist-end-to-end-mlops"
